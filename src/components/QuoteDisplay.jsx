...
export const QuoteDisplay = ({ fullPage = false }) => {
  ...
  return (
    <div className={`${fullPage ? 'h-[70vh] flex items-center justify-center' : ''}`}>
      <div className={`relative bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 overflow-hidden ${fullPage ? 'max-w-2xl mx-auto' : ''}`}>
        ...
        {loading ? (
          ...
          <blockquote className="italic text-gray-700 dark:text-gray-300 text-lg">
            "{quote.text}"
